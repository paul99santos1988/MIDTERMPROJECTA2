...
public class Queries {
    ...
    public static ArrayList<Articles> fetchNewsData(String requestUrl){
        ...
        ArrayList<Articles> newsArticles = extractFeatureFromJson(jsonResponse);
        return newsArticles;
    }
    ...
    private static ArrayList<Articles> extractFeatureFromJson(String newsJson){
        ...
        try{
            ...
            for(int i = 0 ; i<newsArray.length(); i++){
                ...
                Articles article = new Articles(author,title,description,url,urlToImage,publishedAt);
